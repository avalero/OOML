...
void TranslateDecorator::genScad(IndentWriter& writer) const
{
	writer << "translate(v=[" << _tx << ", " << _ty << ", " << _tz << "]) {" << std::endl;
	{
...
void TranslateDecorator::printAst(IndentWriter& writer) const
{
	writer << "TRANSLATE(" << _tx << ", " << _ty << ", " << _tz << ")" << std::endl;
